...
export default function WhatsAppButton() {
  ...
  const message = encodeURIComponent(
    "Hi! I'm interested in joining Master's Unisex Gym. Can you provide more information?"
  );
  ...
  return (
    ...
    >
      ...
      {/* Main button */}
      <div className="relative bg-green-500 hover:bg-green-600 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-2xl transform group-hover:scale-110 transition-all duration-300">
        <svg
          className="w-8 h-8"
          fill="currentColor"
          viewBox="0 0 24 24"
